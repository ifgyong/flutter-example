...
gitModelFromJson(GitModel data, Map<String, dynamic> json) {
  if (json['id'] != null) {
  ...
  if (json['owner'] != null) {
    data.owner = new GitOwner().fromJson(json['owner']);
  }
  ...
  if (json['size'] != null) {
    data.size = json['size']?.toDouble();
  }
  if (json['stargazers_count'] != null) {
    data.stargazersCount = json['stargazers_count']?.toDouble();
  }
  if (json['watchers_count'] != null) {
    data.watchersCount = json['watchers_count']?.toDouble();
  }
  ...
  if (json['forks_count'] != null) {
    data.forksCount = json['forks_count']?.toDouble();
  }
  ...
  if (json['open_issues_count'] != null) {
    data.openIssuesCount = json['open_issues_count']?.toDouble();
  }
  if (json['license'] != null) {
    data.license = new GitLicense().fromJson(json['license']);
  }
  if (json['forks'] != null) {
    data.forks = json['forks']?.toDouble();
  }
  if (json['open_issues'] != null) {
    data.openIssues = json['open_issues']?.toDouble();
  }
  if (json['watchers'] != null) {
    data.watchers = json['watchers']?.toDouble();
  }
...
Map<String, dynamic> gitModelToJson(GitModel entity) {
...
gitOwnerFromJson(GitOwner data, Map<String, dynamic> json) {
  if (json['login'] != null) {
...
Map<String, dynamic> gitOwnerToJson(GitOwner entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
...
gitLicenseFromJson(GitLicense data, Map<String, dynamic> json) {
  if (json['key'] != null) {
...
Map<String, dynamic> gitLicenseToJson(GitLicense entity) {
  final Map<String, dynamic> data = new Map<String, dynamic>();
  data['key'] = entity.key;
  data['name'] = entity.name;
